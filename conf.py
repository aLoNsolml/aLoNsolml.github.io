...
BLOG_AUTHOR = "Alonso Ogueda Oliva"  # (translatable)
BLOG_TITLE = {"es": "aLoNsolml's Vlog!",
              "en": "aLoNsolml's Vlog!"}  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://alonsolml.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://alonsolml.github.io/"
BLOG_EMAIL = "alonso.ogueda@gmail.com"
BLOG_DESCRIPTION = {"es": "Un blog épico! De nerds para nerds.",
                    "en": "An epic blog! From nerds to nerds."}  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/pages/sobre-mi', 'Sobre mi', 'fa fa-user'),
        ('https://twitter.com/aLoNso_lml', 'Mi Twitter', 'fab fa-twitter'),
        ('https://github.com/aLoNsolml', 'Mi Github', 'fab fa-github'),
        ('https://www.instagram.com/lml.alonso.lml', 'Mi Instagram', 'fab fa-instagram'),
    ),
    'en': (
        ('/en/index.html', 'Home', 'fa fa-home'),
        ('/en/archive.html', 'Archives', 'fa fa-folder-open'),
        ('/en/categories/index.html', 'Tags', 'fa fa-tags'),
        ('/en/rss.xml', 'RSS', 'fa fa-rss'),
        ('/en/pages/sobre-mi', 'About me', 'fa fa-user'),
        ('https://twitter.com/aLoNso_lml', 'My Twitter', 'fab fa-twitter'),
        ('https://github.com/aLoNsolml', 'My Github', 'fab fa-github'),
        ('https://www.instagram.com/lml.alonso.lml', 'My Instagram', 'fab fa-instagram'),
    ),
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "alonsolml-github-io"
